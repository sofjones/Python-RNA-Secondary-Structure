...
Much of this component is derived from https://dash.plotly.com/dash-bio/fornacontainer
with changes to allow for the contents of our output file SEQ_DB.tsv
